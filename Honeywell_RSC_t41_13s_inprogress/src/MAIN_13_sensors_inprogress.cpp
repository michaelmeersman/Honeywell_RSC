...
void loop() {
  ...
  for (int i = 0; i<10; ++i){
    ...
    Serial.print(rsc3.read_pressure(),4);
    Serial.print('\t');

    rsc4.select_pressure();
    Serial.print(rsc4.read_pressure(),4);
    Serial.print('\t');

    rsc5.select_pressure();
    Serial.print(rsc5.read_pressure(),4);
    Serial.print('\t');

    rsc6.select_pressure();
    Serial.print(rsc6.read_pressure(),4);
    Serial.print('\t');

    rsc7.select_pressure();
    Serial.print(rsc7.read_pressure(),4);
    Serial.print('\t');

    rsc8.select_pressure();
    Serial.print(rsc8.read_pressure(),4);
    Serial.print('\t');

    rsc9.select_pressure();
    Serial.print(rsc9.read_pressure(),4);
    Serial.print('\t');

    rsc10.select_pressure();
    Serial.print(rsc10.read_pressure(),4);
    Serial.print('\t');

    rsc11.select_pressure();
    Serial.print(rsc11.read_pressure(),4);
    Serial.print('\t');

    rsc12.select_pressure();
    Serial.print(rsc12.read_pressure(),4);
    Serial.print('\t');
